...
describe('calculateTotalPoints', () => {
    describe('windFactor', () => {
        ...
        it('should return total points if windFactor is a negative number', () => {
            const actual = calculateTotalPoints(100, 'normal', 100, [16, 16.5, 17, 17.5, 18], -8, -8.4)
        ...
        it('should return "wrong type of windFactor" if windFactor is different than "number"', () => {
            const actual = calculateTotalPoints(100, 'normal', 100, [16, 16.5, 17, 17.5, 18], "0", -8.4)
    ...
    describe('gateFactor', () => {
        ...
        it('should return "wrong type of gateFactor" if gateFactor is different than "number"', () => {
            const actual = calculateTotalPoints(100, 'normal', 100, [16, 16.5, 17, 17.5, 18], 8.2, "-8.4")
